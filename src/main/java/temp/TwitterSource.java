...
public class TwitterSource extends AbstractSource
    ...
    private static String KEYWORDS_KEY="kewords_key";
    ...
    public void configure(Context context) {
        consumerKey = context.getString(CONSUMER_KEY);
        consumerSecret = context.getString(CONSUMER_SECRET);
        accessToken = context.getString(ACCESS_TOKEN);
        accessTokenSecret = context.getString(ACCESS_SECRET);

        logger.info("entering to the flume confinguration of code.....");
